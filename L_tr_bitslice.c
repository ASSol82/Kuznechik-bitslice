...
//	T vb[128];
//	
//	printf("L_transform_bitslice test ... ");
//	copy_tr(a, L_tr_in);
//	//print_a(a); printf("\n");
//	
//	ConvertToBitSlice128(5, a, vb);
//	ConvertToBitSlice128(6, a, vb);
//	ConvertToBitSlice128(7, a, vb);
//	//20250221
//	//ConvertToBitSlice128_2(5, a, vb);
//	//ConvertToBitSlice128_2(6, a, vb);
//	//ConvertToBitSlice128_2(7, a, vb);
//	for (i = 0; i < 4; ++i)
//	{
//		L_transform_bitslice(vb);
//		ConvertFromBitSlice128(5, vb, a);
//		//print_a(a); printf("\n");
//		if (!equal_tr(a, L_tr_out[i]))
//		{
//			printf("error\n");
//			return 1;
//		}
...
//	printf("ok\n");
//
//	printf("L_invert_transform_bitslice test ... ");
//	for (i = 0; i < 4; ++i)
//	{
//		L_invert_transform_bitslice(vb);
//	}
//	ConvertFromBitSlice128(5, vb, a);
//	if (!equal_tr(a, L_tr_in))
//	{
//		printf("error\n");
//		return 1;
//	}
//	printf("ok\n");
//
//	return r; // r=0 тест завершен успешно, r=1 тест завершен неуспешно
//}
