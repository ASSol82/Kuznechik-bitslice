...
void subst_invert_tr(uint8_t* a)
{
	...
	for (i = 0; i < 16; ++i)
	{
		a[i] = PiStroke_invert[a[i]];
	}
}


// генерирует обратную подстановку
//void Generate_invert_PiStroke_subst()
//{
//	uint8_t PiStroke_invert[256];
//	int i;
//	for (i = 0; i < 256; ++i)
//	{
//		PiStroke_invert[PiStroke[i]] = i;
//	}
//
//	printf("const uint8_t PiStroke_invert[] = { ");
//	for (i = 0; i < 256; ++i)
//	{
//		if (i) printf(", ");
//		printf("%d", PiStroke_invert[i]);
//	}
//	printf(" };\n");
//}
